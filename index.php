<?php
$connect = new PDO("mysql:host=localhost;dbname=building_managment", "root", "");
 ...
 <body>
  ...
  <div class="container">
   <div class="row">
    ...
    ?>
     <div class="checkbox">
      <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $table["Tables_in_building_managment"]; ?>" /> <?php echo $table["Tables_in_building_managment"]; ?></label>
     </div>
    <?php
    }
    ?>
